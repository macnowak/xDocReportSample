...
function $LocationProvider(){
   ...
   * @category broadcast on root scope
   * @description
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       * @category broadcast on scope being destroyed
       *
       * @description
...
function baseInputType(scope, element, attr, ctrl, $sniffer, $browser) {
  ...
  if ($sniffer.hasEvent('input')) {
    ...
    // if user modifies input value using context menu.html in IE, we need "paste" and "cut" events to catch it
 ...
 * @category emit on the scope ngInclude was declared in
 * @description
 ...
 * @category emit on the current ngInclude scope
 * @description
 ...
 *
 * When an item in the `<select>` menu.html is selected, the array element or object property
